...
class QuestionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $question = Question::create(['section_id'=>1, 'question_e'=> 'Age (Years)', 'question_u'=>'عمر (سال)', 'question_type'=>'TextField']);
        $question = Question::create(['section_id'=>1, 'question_e'=> 'Qualification', 'question_u'=>'تعلیم', 'question_type'=>'TextField']);
