...
const form = useForm({
    section_id: props.question?.section_id,
    question_type: props.question?.question_type,
    question_e: props.question?.question_e,
    question_u: props.question?.question_u,
...
const deletePost = (id) => {
    form.delete(route("questions.options.destroy", [props.question?.id, id]), {
  ...
  <AdminLayout>
    <div class="max-w-7xl mx-auto py-4">
      ...
      <div class="mt-6 max-w-6xl mx-auto bg-slate-100 shadow-lg rounded-lg p-6">
        <h1 class="text-2xl font-semibold text-indigo-700">Update Question</h1>
        <form @submit.prevent="form.put(route('questions.update', question.id))">
                        ...
                        <template #default>
                            ...
                            >
                                ...
                                <TableDataCell class="space-x-4">
                                    <button
                                        v-if="option.id"
                                        @click.prevent="confirmDeletePost"
                                    ...
                                    >
                                        <div class="p-6">
                                            ...
                                            <div class="mt-6 flex space-x-4">
                                                <DangerButton v-if="option.id" @click.prevent="deletePost(option.id)">Delete</DangerButton>
